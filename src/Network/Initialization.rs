    ...
    E: &mut arrayfire::Array<Z>)
{
    ...
    *A = 2.12616013f64 + 0.0001*NEURONSTD*arrayfire::randn::<f64>(H_dims);
    *B = (1.0f64/2.12616013f64) + 0.0001*NEURONSTD*arrayfire::randn::<f64>(H_dims);
    *C = 0.0000001*NEURONSTD*arrayfire::randn::<f64>(H_dims);
    *D = 2.12616013f64 + 0.0001*NEURONSTD*arrayfire::randn::<f64>(H_dims);
    *E = -1.0f64 +  0.0001*NEURONSTD*arrayfire::randn::<f64>(H_dims);
